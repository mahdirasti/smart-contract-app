...
import SocialAvatar from "@/components/pages/start-project/contract-details/sidebar/social-avatar";
...
interface IContractSidebarProps {}

const ContractSidebar: React.FunctionComponent<IContractSidebarProps> = (
  props
) => {
