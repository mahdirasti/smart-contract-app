...
const Uploader: React.FC<UploaderProps> = ({
    ...
    if (uploadAfterDrop) {
      ...
      api
        ...
        .then((res: any) => {
          ...
          setUploadedUrl(original_url);
          setUploading(false);
          if (onUpload) {
            onUpload(original_url, item);
          }
        })
        .catch((err: any) => {
          setUploading(false);
  ...
  const onDrop = useCallback((acceptedFiles) => {
    ...
    //Do Upload if ready for uploading
    doUpload();
  }, []);
  ...
  const RenderUploaderIcon = useCallback(() => {
    const sxIcon = {
      [`&`]: {
  ...
  return (
    <>
      ...
      >
        {style === "minimal" ? MinimalUploaderInner : StandardUploaderInner}
