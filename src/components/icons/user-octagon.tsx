...
interface IUserOctagonIconProps extends IconType {
  width?: number;
  height?: number;
}

const UserOctagonIcon: React.FunctionComponent<IUserOctagonIconProps> = ({
  color = "#D4D4D4",
  width = 22,
  height = 22,
}) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M12 11.0001C13.2868 11.0001 14.33 9.95687 14.33 8.67004C14.33 7.38322 13.2868 6.34009 12 6.34009C10.7132 6.34009 9.66998 7.38322 9.66998 8.67004C9.66998 9.95687 10.7132 11.0001 12 11.0001Z"
        stroke={color}
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
